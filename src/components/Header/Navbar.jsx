...
const Navbar = () => {
  ...
  const links = (
    <>
      <li>
        <NavLink to="/" className="text-black transition-colors">
          Home
        </NavLink>
      </li>
      <li>
        <NavLink to="/about" className="text-black transition-colors">
          About
        </NavLink>
      </li>
      <li>
    ...
    <div className="navbar bg-blue-100 shadow-md sticky top-0 z-50 px-4">
      ...
      <div className="navbar-start">
        ...
        <Link to="/" className="flex items-center">
          <p className="btn btn-ghost text-xl md:text-2xl font-bold ">
            Pet Center
          </p>
        </Link>
      </div>
        ...
        {user && (
          <Link to="/myprofile" className="flex items-center gap-2 mr-2">
            <div className="relative group">
              ...
              />
              <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 hidden whitespace-nowrap rounded bg-white px-2 py-1 text-xs text-black group-hover:block">
